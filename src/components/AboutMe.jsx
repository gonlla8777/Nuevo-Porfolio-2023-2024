const About = () => {
  return (
    <div id="aboutMe" className="h-auto ">
      <h1 className="font-bold font-sans text-7xl p-2 animate-fade-up">
        About Me
      </h1>
      <h2 className="font-light font-sans text-2xl p-4 animate-fade animate-once animate-ease-in animate-duration-[2000ms]">
